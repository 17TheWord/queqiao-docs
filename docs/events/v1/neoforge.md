...
- `NeoForge` 事件命名及字段与 `Forge` 基本一致
- 故对 `NeoForge` 的事件名增加 `Neo` 前缀
...
|   event_name   |      string       | `NeoServerChatEvent` |    事件名称    |
...
|   event_name   |      string       | `NeoPlayerDeathEvent` |    事件名称    |
...
|   event_name   |      string       | `NeoCommandEvent` |    事件名称    |
...
|   event_name   |      string       | `NeoPlayerLoggedInEvent` |    事件名称    |
...
|   event_name   |      string       | `NeoPlayerLoggedOutEvent` |    事件名称    |
